...
class FastoboParser(abc.ABC):
    ...
    def _extract_definition(self, clause: Union[fastobo.term.DefClause, fastobo.typedef.DefClause]) -> Definition:
    ...
    def _extract_property_value(self, pv: fastobo.pv.AbstractPropertyValue) -> PropertyValue:
    ...
    def _extract_term(self, frame: fastobo.term.TermFrame) -> Term:
        ...
        _callbacks = {
            ...
            fastobo.term.DefClause:
                lambda c: setattr(term, "definition", self._extract_definition(c)),
            ...
            fastobo.term.SynonymClause:
                lambda c: termdata.synonyms.add(self._extract_synonym_data(c.synonym)),
    ...
    def _extract_relationship(self, frame: fastobo.typedef.TypedefFrame) -> Relationship:
        ...
        _callbacks = {
            ...
            fastobo.typedef.DefClause:
                lambda c: setattr(rship, "definition", self._extract_definition(c)),
            ...
            fastobo.typedef.ExpandAssertionToClause: (lambda c:
                rshipdata.expand_assertion_to.add(self._extract_definition(c))
            ),
            fastobo.typedef.ExpandExpressionToClause: (lambda c:
                rshipdata.expand_expression_to.add(self._extract_definition(c))
            ),
            ...
            fastobo.typedef.SynonymClause:
                lambda c: rshipdata.synonyms.add(self._extract_synonym_data(c.synonym)),
            ...
            fastobo.typedef.XrefClause:
                add("xref", "xrefs", cb=self._extract_xref),
        }
